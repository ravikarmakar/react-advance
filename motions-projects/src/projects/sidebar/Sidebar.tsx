    ...
    <div className="relative">
      ...
      >
        <div className="p-4">
          <button
            ...
            className="absolute cursor-pointer top-4 right-4 z-10 p-2 bg-gray-800 text-white rounded-full focus:outline-none"
          >
      ...
      <button
        ...
        className="absolute top-4 left-4 z-10 p-2 bg-gray-800
         text-white rounded-full focus:outline-none cursor-pointer"
      >
        {isOpen ? (
          <IoMdArrowBack className="h-6 w-6" />
        ) : (
